...
**Current step:** ⏭ **Step 2 — [#79](https://github.com/Genesara/genesara-engine/issues/79) Surgical Redis moves: cooldowns, kill streaks, pending attack scales** *(can run in parallel with Step 3)*
...
- [ ] **Step 2** — [#79](https://github.com/Genesara/genesara-engine/issues/79) Surgical Redis moves: cooldowns, kill streaks, pending attack scales *(blocked by #78; can run in parallel with #80)*
