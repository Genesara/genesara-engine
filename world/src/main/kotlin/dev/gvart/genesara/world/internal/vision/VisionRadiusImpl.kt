...
internal class VisionRadiusImpl(
    ...
    override fun radiusFor(
        ...
        val watchtowerBonus = if (
            activeBuildingsAtCurrentNode.any { it.type == BuildingType.WATCHTOWER && it.status == BuildingStatus.ACTIVE }
        ) WATCHTOWER_AURA else 0
