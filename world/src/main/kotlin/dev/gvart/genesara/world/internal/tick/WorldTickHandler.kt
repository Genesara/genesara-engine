...
class WorldTickHandler(
    ...
    private val clans: dev.gvart.genesara.world.ClanRegistry,
    private val clanInvites: dev.gvart.genesara.world.ClanInviteStore,
    private val factions: dev.gvart.genesara.world.FactionRegistry,
    private val factionInvites: dev.gvart.genesara.world.FactionInviteStore,
    ...
    override fun tickOne(worldId: WorldId, number: Long) {
        ...
        val (next, commandEvents) = commands.fold(afterNpcAi to emptyList<WorldEvent>()) { (state, acc), command ->
            reduce(
                ...
                clans, clanInvites, factions, factionInvites,
