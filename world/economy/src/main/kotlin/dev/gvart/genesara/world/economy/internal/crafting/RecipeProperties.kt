 ...
 * and [dev.gvart.genesara.world.environment.internal.buildings.BuildingProperties] — and are
...
data class RecipeOutputProperties(
    val item: String,
    val quantity: Int = 1,
)
 ...
 */
data class RecipeUnlockModeProperties(
