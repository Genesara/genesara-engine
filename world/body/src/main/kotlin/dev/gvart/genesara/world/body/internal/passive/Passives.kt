package dev.gvart.genesara.world.body.internal.passive
 ...
 */
data class EquipmentBonusSnapshot(
 ...
 */
val staminaRegenPassive = Passive { state, balance, bonuses ->
 ...
 */
val gaugeDrainPassive = Passive { state, balance, _ ->
 ...
 */
val sleepPassive = Passive { state, balance, _ ->
 ...
 */
val starvationDamagePassive = Passive { state, balance, _ ->
