 ...
 * HP via [starvationDamagePassive][dev.gvart.genesara.world.body.internal.passive.starvationDamagePassive])
...
class StarvationDeathRespawnIntegrationTest {
    ...
    private class NoOpEquipmentStore : dev.gvart.genesara.world.internal.testsupport.InMemoryAgentItemInstancesStore() {
